...
int main() {
    ...
    hidden_w.setValue(0, 0, 1.20f);
    hidden_w.setValue(0, 1, -0.70f);
    hidden_w.setValue(0, 2, 0.50f);
    hidden_w.setValue(1, 0, 0.30f);
    hidden_w.setValue(1, 1, 1.10f);
    hidden_w.setValue(1, 2, -0.40f);

    Matrix<float, CPU> hidden_b(1, 3);
    hidden_b.setValue(0, 0, 0.10f);
    hidden_b.setValue(0, 1, -0.20f);
    hidden_b.setValue(0, 2, 0.05f);
