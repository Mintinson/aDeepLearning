...
Matrix<float, CPU> build_features()
{
    ...
    x.setValue(4, 0, 0.1f); x.setValue(4, 1, 0.8f);
    x.setValue(5, 0, 0.8f); x.setValue(5, 1, 0.2f);
    x.setValue(6, 0, 0.9f); x.setValue(6, 1, 0.9f);
    x.setValue(7, 0, 0.2f); x.setValue(7, 1, 0.1f);
...
int main()
{
    ...
    eval_points.setValue(0, 0, 0.0f); eval_points.setValue(0, 1, 0.0f);
    eval_points.setValue(1, 0, 0.0f); eval_points.setValue(1, 1, 1.0f);
    eval_points.setValue(2, 0, 1.0f); eval_points.setValue(2, 1, 0.0f);
    eval_points.setValue(3, 0, 1.0f); eval_points.setValue(3, 1, 1.0f);
