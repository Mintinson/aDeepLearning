...
struct DataCategory {
private:
    template <bool isScalar, bool isMatrix, bool isBatchScalar, bool isBatchMatrix, typename Dummy = void>
    struct helper;
...
public:
    ...
    using type = typename details::
        DataCategoryHelper<IsScalar_v<T>, IsMatrix_v<T>, IsBatchScalar_v<T>, IsBatchMatrix_v<T>>::type;
};
