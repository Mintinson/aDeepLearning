...
namespace metann {
    ...
    namespace details {
        ...
        struct NLLFeedback {
            ...
            static void recordData(const TLabel &label, const TIn &in,
            ...
            static auto feedback(const TGrad &p_grad, TData &label, TData &pred) {
                ...
                auto res = neg_log_likelihood_derivative(g, std::move(l), std::move(p));
    ...
    public:
        static constexpr bool isFeedbackOutput = details::PolicySelect_t<
            FeedbackPolicy, CurrentLayerPolicy>::isFeedbackOutput;
    ...
    public:
        ...
        auto feedforward(const Input &p_in) {
            ...
            return OutputType::create().template set<OutputType>(neg_log_likelihood(label, input));
        }
